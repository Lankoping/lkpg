...
import { updateInfoSectionFn, createInfoSectionFn, deleteInfoSectionFn } from '../server/functions/cms'
...
const ICON_NAMES = ['MapPin', 'Users', 'Cpu', 'Zap', 'Trophy', 'Heart', 'Star', 'Rocket', 'Wifi', 'Code', 'Crown', 'Shield']

export function InfoSectionsPageClient({ initialSections }: { initialSections: InfoSection[] }) {
  ...
  const resetForm = () => {
    setFormData({ slug: '', icon: 'Star', title: '', description: '', sortOrder: 0 })
    setEditingId(null)
    setShowForm(false)
  }
